...
+ (NSString*) flattenCollection: (NSArray*) array withFormat: (NSString*) fmt andSeparator: (NSString*) separator withIndex: (BOOL) withIndex
{
    ...
    while (element = [e nextObject])
    {
		...
		if (withIndex)
		{
		    NSString* elemIndexer = [NSString stringWithFormat: @"[%@]", index];
